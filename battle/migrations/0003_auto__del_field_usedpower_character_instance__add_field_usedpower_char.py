...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UsedPower.character_instance'
        db.delete_column(u'battle_usedpower', 'character_instance_id')

        # Adding field 'UsedPower.character_status'
        db.add_column(u'battle_usedpower', 'character_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['battle.CharacterStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UsedPower.character_instance'
        db.add_column(u'battle_usedpower', 'character_instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['battle.CharacterStatus']),
                      keep_default=False)

        # Deleting field 'UsedPower.character_status'
        db.delete_column(u'battle_usedpower', 'character_status_id')
    ...
    models = {
        ...
        u'battle.usedpower': {
            ...
            'character_status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['battle.CharacterStatus']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'power': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['battle.Power']"})
        }
    }
