    ...
    */
    ...
    $document.bind('mouseup', function (ev) {
      ...
      var accepts = function () {
        return (dropArea.attr('btf-dragon')||dropArea.attr('btf-dragon-drop-function')) &&
      ...
      var dropFunction = dropArea.attr('btf-dragon-drop-function') &&
          dropArea.scope().$eval(dropArea.attr('btf-dragon-drop-function'));

      if (dropArea.length > 0) {
        var targetScope = dropArea.scope();var expression = dropArea.attr('btf-dragon');
        var fn;
        ...
        if (!dragDuplicate || dragOrigin != targetList)
          targetScope.$apply(fn);
    ...
    return {
      ...
      compile: function (container, attr) {
        ...
        return function (scope, elt, attr) {
          ...
          var dropFunction = scope.$eval(attr.btfDragonDropFunction);

          if (dropFunction !== undefined && typeof dropFunction !== 'function') {
            throw Error('Expected btfDragonDropFunction to be a function.');
          }
