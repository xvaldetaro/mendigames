...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mendigames_item', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Item.name'
        db.alter_column(u'mendigames_item', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
