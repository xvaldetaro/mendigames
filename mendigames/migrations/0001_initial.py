...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mendigames_character', (
            ...
            ('container', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='character', unique=True, null=True, to=orm['mendigames.Container'])),
        ...
        db.create_table(u'mendigames_mundane', (
            ...
            ('wizards_id', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('html_description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mundanes', to=orm['mendigames.Category'])),
        ...
        # Adding unique constraint on 'M2MMagicSubtype', fields ['magic', 'subtype']
        db.create_unique(u'mendigames_m2mmagicsubtype', ['magic_id', 'subtype_id'])
        ...
        db.create_table(u'mendigames_item', (
            ...
            ('magic', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='items', null=True, to=orm['mendigames.Magic'])),
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'M2MMagicSubtype', fields ['magic', 'subtype']
        db.delete_unique(u'mendigames_m2mmagicsubtype', ['magic_id', 'subtype_id'])
