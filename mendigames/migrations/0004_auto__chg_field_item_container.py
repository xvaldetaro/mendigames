...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.container'
        db.alter_column(u'mendigames_item', 'container_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mendigames.Container']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Item.container'
        raise RuntimeError("Cannot reverse this migration. 'Item.container' and its values cannot be restored.")
    ...
    models = {
        ...
        u'mendigames.item': {
            ...
            'container': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'null': 'True', 'to': u"orm['mendigames.Container']"}),
