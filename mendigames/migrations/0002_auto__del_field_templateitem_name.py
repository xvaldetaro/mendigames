...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TemplateItem.name'
        db.delete_column(u'mendigames_templateitem', 'name')


    def backwards(self, orm):
        # Adding field 'TemplateItem.name'
        db.add_column(u'mendigames_templateitem', 'name',
