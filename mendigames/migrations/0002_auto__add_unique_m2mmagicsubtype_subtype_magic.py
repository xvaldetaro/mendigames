...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'M2MMagicSubtype', fields ['subtype', 'magic']
        db.create_unique(u'mendigames_m2mmagicsubtype', ['subtype_id', 'magic_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'M2MMagicSubtype', fields ['subtype', 'magic']
        db.delete_unique(u'mendigames_m2mmagicsubtype', ['subtype_id', 'magic_id'])
