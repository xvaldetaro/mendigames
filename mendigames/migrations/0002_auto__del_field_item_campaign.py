...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.campaign'
        db.delete_column(u'mendigames_item', 'campaign_id')


    def backwards(self, orm):
        # Adding field 'Item.campaign'
        db.add_column(u'mendigames_item', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mendigames.Campaign'], null=True),
                      keep_default=False)
